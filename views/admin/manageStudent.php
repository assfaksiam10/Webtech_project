...
$studentList=getUsersByRole("student");
?>
        ...
        <div class="main">
            ...
            <div class="panel">
                ...
                <form action="../../controllers/addUserControls.php" method="post">
                    ...
                    <input type="submit" name="submit" value="Add Student" class="btnOrange">
                </form>
            </div>
                ...
                <table>
                    ...
                    <?php
                        while($row=mysqli_fetch_assoc($studentList))
                        {
                            ...
                            echo "<td><a href='../../controllers/deleteUserControls.php?userId=".$row["userId"]."&role=student'><button class='btnRemove'>Remove</button></a></td>";
                            echo "</tr>";
                        }
                    ?>
                </table>
