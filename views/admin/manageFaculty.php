...
$facultyList=getUsersByRole("faculty");
?>
        ...
        <div class="main">
            ...
            <div class="panel">
                ...
                <form action="../../controllers/addUserControls.php" method="post">
                    ...
                    <input type="submit" name="submit" value="Add Faculty" class="btnOrange">
                </form>
            </div>
            ...
            <div class="panel">
                ...
                <table>
                    ...
                    <?php
                        while($row=mysqli_fetch_assoc($facultyList))
                        {
                            echo "<tr>";
                            echo "<td>".$row["userId"]."</td>";
                            echo "<td>".$row["name"]."</td>";
                            echo "<td>".$row["email"]."</td>";
                            echo "<td><a href='../../controllers/deleteUserControls.php?userId=".$row["userId"]."&role=faculty'><button class='btnRemove'>Remove</button></a></td>";
                            echo "</tr>";
                        }
                    ?>
                </table>
